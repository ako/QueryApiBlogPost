...
public class Microflows
{
	...
	public static void addEntityListeners(IContext context)
	{
		try
		{
			Map<java.lang.String, Object> params = new HashMap<java.lang.String, Object>();
			Core.execute(context, "Hr.AddEntityListeners", params);
		}
	...
	public static java.util.List<hr.proxies.DepartmentSummary> retrieveDepartmentSummaryOrderByByDatasetOql(IContext context)
	{
		try
		{
			Map<java.lang.String, Object> params = new HashMap<java.lang.String, Object>();
			java.util.List<IMendixObject> objs = Core.execute(context, "Hr.RetrieveDepartmentSummaryOrderByByDatasetOql", params);
			java.util.List<hr.proxies.DepartmentSummary> result = null;
			if (objs != null)
			{
				result = new java.util.ArrayList<hr.proxies.DepartmentSummary>();
	...
	public static java.util.List<hr.proxies.Employee> retrieveEmployeesByXpath_2(IContext context, java.lang.String _employeeNameFilter)
	{
		try
		{
			Map<java.lang.String, Object> params = new HashMap<java.lang.String, Object>();
			params.put("EmployeeNameFilter", _employeeNameFilter);
			java.util.List<IMendixObject> objs = Core.execute(context, "Hr.RetrieveEmployeesByXpath_2", params);
			java.util.List<hr.proxies.Employee> result = null;
			if (objs != null)
			{
				result = new java.util.ArrayList<hr.proxies.Employee>();
